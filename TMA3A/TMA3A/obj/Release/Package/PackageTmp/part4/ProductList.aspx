<%@ Page Title="" Language="C#" MasterPageFile="~/part4/Layout.Master" AutoEventWireup="true" CodeBehind="ProductList.aspx.cs" Inherits="TMA3.part4.ProductList" %>
	...
	<asp:UpdatePanel ID="UpdatePanel1" runat="server">
		<ContentTemplate>
			<div class="container" id="product-list">
				...
				<div class="no-side">
					<div class="item-list">
						<asp:ListView ID="ComputerList" runat="server" DataKeyNames="ComputerID" ItemType="TMA3.part4.Models.Computer" SelectMethod="GetComputers">
							<ItemTemplate>
