<%@ Page Title="" Language="C#" MasterPageFile="~/part3/Layout.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="TMA3.part3.Product" %>
			...
			<div class="container" id="product">
				<div class="no-side">
					<div class="detail border-box">
						<div>
							<asp:Image runat="server" ImageUrl="img/Laptop.png"/>
						</div>
						<div class="info">
							<div>
