<%@ Page Title="" Language="C#" MasterPageFile="~/part3/Layout.Master" AutoEventWireup="true" CodeBehind="MyCart.aspx.cs" Inherits="TMA3.part3.MyCart" %>
			...
			<div class="container" id="my-cart">
				<div class="no-side">
					...
					<div class="cart-list">
						...
						<asp:ListView ID="CartList" runat="server" DataKeyNames="ComputerID" ItemType="TMA3.part3.Models.Computer" OnItemCommand="OnItemCommand">
							<ItemTemplate>
